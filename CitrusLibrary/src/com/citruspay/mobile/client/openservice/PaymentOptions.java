...
public class PaymentOptions {
    ...
    public void getPaymentOptions(String service_url, String vanity, OnTaskCompleted listener) {
        this.vanity = vanity;
    ...
    private class AsynchOption extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            HttpPost httppost = new HttpPost(service_url + "service/v1/merchant/pgsetting");
